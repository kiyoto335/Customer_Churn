        ...
        if 'Churn' not in processed_data.columns:
            ...
            if st.button("🚀 Train Models", type="primary"):
                ...
                if models:
                    ...
                    # Style the dataframe
                    styled_df = results_df.style.highlight_max(axis=0,
            ...
            with tab2:
                ...
                with col2:
                    ...
                    if 'StreamingMovies' in original_data.columns:
                        input_data['StreamingMovies'] = st.selectbox("Streaming Movies",
            ...
            with tab3:
                ...
                with col1:
                    ...
                    if 'PaperlessBilling' in original_data.columns:
                        input_data['PaperlessBilling'] = st.selectbox("Paperless Billing",
...
# Page 6: Interpretation & Report
    ...
    if st.session_state.data is None:
        ...
        st.write(st.session_state.get("interpretation_text",
                                      "No detailed interpretation available. Please ensure the model has been analyzed."))
